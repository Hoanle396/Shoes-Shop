...
const Card = (props: product) => {
  ...
  return (
    <div className="z-[9998] shadow-lg rounded-3xl sm-x2:mx-auto  sm-x2:w-[266px]  w-[300px]">
      ...
      >
        ...
        {isExists?.length ? (
              ...
              <>
                {data.id == props.id ? (
                  ...
                  <button
                    ...
                    className="bg-[#32958e] transition-colors hover:bg-[#305f5c] w-full rounded-md py-2 text-white mt-8"
                  >
                    add to cart
                  </button>
                )}
          ...
          <button
            onClick={addToCartHandler}
            className="bg-[#32958e] transition-colors hover:bg-[#305f5c] w-28 rounded-md py-2 text-white px-4 mt-8"
          >
            add to cart
          </button>
        )}
