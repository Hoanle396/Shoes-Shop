  ...
  return (
    <>
      <section className="h-full relative">
        ...
        >
          {" "}
          <span className="relative left-3">scroll down</span>{" "}
          <img
            width={"2rem"}
      ...
      <div className="relative">
        ...
        <div className="mt-40">
          <div className="flex justify-between lg:mx-10 sm-x2:!mx-5 mx-40">
            ...
            <WavyLink to="/AllProducts" duration={1000} color="#fff">
              {" "}
              <p className="text-center flex justify-end items-center gap-2    pb-5   sm-x2:text-[19px] text-[#024742]  text-[20px] l mb-16">
          ...
          <main className="sm-x2:hidden grid gap-20 lg:justify-evenly sm:!grid-cols-[auto] lg:grid-cols-[auto,auto] xl:grid-cols-[auto,auto,auto] xl:grid-cols-3 lg:mx-10 sm-x2:!mx-5 grid-cols-[auto,auto,auto,auto] justify-between mx-40">
            {products &&
              products
                .slice(0, 12)
                .map((data) => <Card key={crypto.randomUUID()} {...data} />)}
          </main>
        </div>
      </div>
      ...
      <div className="mt-64 pt-10 bg-[#024742] pb-6 " id="gallery">
        <div className="flex justify-between sm:flex-wrap  sm:flex-col-reverse sm:justify-center sm:gap-3  lg:mx-10 sm-x2:!mx-5 mx-40">
          <p
            ...
            className="text-left sm:text-center   text-[#ffffff] sm:text-[1rem] text-4xl mb-16"
          >
