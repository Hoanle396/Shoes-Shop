      ...
      {cart.length ? (
        <main className="h-[100vh] md:h-full md:pb-20 md:gap-5 flex lg:gap-20 md:flex-col gap-10">
          <section className="pt-12 w-1/2 md:w-full ">
            <p className="text-5xl text-white sm-x2:text-2xl   my-8">
              Products:
            </p>
            <hr className="w-full" />
            {cart.map((product) => (
        ...
        <main className="mx-auto block w-max text-center pt-48 pb-56">
          ...
          <WavyLink duration={1000} color="#024742" to="/">
            <button className="border border-solid border-white text-white px-3 hover:text-[#024742] hover:bg-white transition-colors py-2 mt-6  rounded-md">
              Go shopping
            </button>
          </WavyLink>
        </main>
